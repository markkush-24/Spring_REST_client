...
//с помощью этого кода мы отправляем request и его результат получаем в responseEntity ,
        ResponseEntity<List<Employee>> responseEntity = restTemplate.exchange(URL, HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Employee>>() {});
//получаем полезную нагрузку/payload из responseEntity , чтобы вернуть всех работников
